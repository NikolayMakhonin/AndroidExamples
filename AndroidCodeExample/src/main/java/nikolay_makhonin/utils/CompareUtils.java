...
import nikolay_makhonin.utils.contracts.delegates.EqualityComparator;
...
public class CompareUtils {
    public static int CompareDelegate(final Object d1, final Object d2) {
        final RefParam<Integer> ref_i = new RefParam<Integer>(0);
        if (CompareNullable(d1, d2, ref_i)) {
            return ref_i.value;
        }
    ...
    public static int compareDelegate(final Object d1, final Object d2) {
        int i = 0;
        if ((i = CompareIdentityHashCode(d1, d2)) != 0) {
            return i;
        }
        return 0;
    }
    ...
    public static final EqualityComparator<String> StringEqualityComparator = new EqualityComparator<String>() {
        @Override
        public Boolean invoke(final String s1, final String s2) {
            return Equals(s1, s2);
        }
    };

    public static final EqualityComparator<String> StringEqualityComparatorIgnoreCase
    ...
    public static final EqualityComparator<Class> TypeEqualityComparator = new EqualityComparator<Class>() {
        @Override
        public Boolean invoke(final Class t1, final Class t2) {
            return t1 == t2;
        }
    };
    ...
    public static final EqualityComparator<Object> IdentityHashCodeEqualityComparator
        = new EqualityComparator<Object>() {
        @Override
        public Boolean invoke(final Object o1, final Object o2) {
            return o1 == o2;
        }
    };
    ...
    public static int CompareTypes(final Class t1, final Class t2) {
        ...
        int i;
        if ((i = Compare(t1.hashCode(), t2.hashCode())) != 0) {
            return i;
        }
        return 0;
    }
    ...
    public static int CompareList(final List o1, final List o2, final Comparator comparator) {
        ...
        if ((i = Compare(cnt, o2.size())) != 0) {
            return i;
        }
        for (int j = 0; j < cnt; j++) {
            if ((i = comparator.compare(o1.get(j), o2.get(j))) != 0) {
                return i;
            }
        }
        return 0;
    ...
    public static <T> int CompareList(final T[] o1, final T[] o2, final Comparator<T> comparator) {
        ...
        if ((i = Compare(cnt, o2.length)) != 0) {
            return i;
        }
        for (int j = 0; j < cnt; j++) {
            if ((i = comparator.compare(o1[j], o2[j])) != 0) {
                return i;
            }
        }
        return 0;
